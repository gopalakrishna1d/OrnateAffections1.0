...
import store_website.views.views_admin as admin_views
import store_website.views.views_order as order_views
import store_website.views.views_prod as prod_views
import store_website.views.views_cart_wishlist as cart_wishlist_views
import store_website.views.views_user_auth as user_auth_views
import store_website.views.views_address as addr_views
import store_website.views.views_index as index_views
...
urlpatterns = [
    ...
    path('user_settings/', user_auth_views.user_settings, name= 'user_settings'),
